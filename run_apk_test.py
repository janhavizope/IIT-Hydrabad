...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Logcat collection duration in seconds (default: 10)",
    )
...
def main() -> None:
    ...
    print("\n================ FINAL VERDICT ================\n")
    print(json.dumps(result.get("final_verdict", {}), indent=2, default=str))

    print("\n================ THREAT INTELLIGENCE ================\n")
    print(json.dumps(result.get("threat_intelligence", {}), indent=2, default=str))

    print("\n================ VISUALIZATION DATA ================\n")
    print(json.dumps(result.get("visualization_data", {}), indent=2, default=str))

    print("\n================ DECISION TRACE ================\n")
    print(json.dumps(result.get("decision_trace", {}), indent=2, default=str))
